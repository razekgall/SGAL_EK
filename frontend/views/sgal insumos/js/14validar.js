// Validador de formularios para Actualización de Insumo
console.log('No es hasta que nos damos cuenta de que significamos algo para los demás que no sentimos que hay un objetivo o propósito en nuestra existencia.Stefan Zweig');
...
try {
  ...
  function showAlert(message, error = null) {
    ...
    if (error == null) {
      ...
      location.href = "/SGL CODE/sgal insumos/Html/5-listar-insumos.html";
    }
